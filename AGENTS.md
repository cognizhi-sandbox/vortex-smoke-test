...
**Vite bound `:5001`**, ending a five-sprint run on `:5000`. The port list in [Gotchas](#gotchas) records it as the same lesson from the other side: the series is contention, not extrapolable in either direction.
