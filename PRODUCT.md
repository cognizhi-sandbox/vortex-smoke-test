...
Added `/healthz-smoke-cancel-1023069404` GET endpoint returning `{ok:true, variant:"1023069404"}`. Self-contained, no auth/database, simple health check for smoke testing. Fourth example of minimal health check pattern.
