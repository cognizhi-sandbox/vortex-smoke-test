# VRTX3-T-0015: Fix /api/healthz-smoke-bugfix3-200192357 → 404

**Defect ID:** smoke-bugfix-17856540658772  
**Endpoint:** GET `/api/healthz-smoke-bugfix3-200192357`  
**Variant ID:** 200192357

---

## Problem Statement

The endpoint `/api/healthz-smoke-bugfix3-200192357` returns HTTP 404 Not Found. Expected behavior: HTTP 200 with response body `{"ok":true,"variant":"200192357"}`.
...
The route file `routes/api/healthz-smoke-bugfix3-200192357.ts` **does not exist**. Nitro's file-based router has no handler for this endpoint, so all requests return 404.
...
### File 1: `routes/api/healthz-smoke-bugfix3-200192357.ts`
...
### File 2: `routes/api/healthz-smoke-bugfix3-200192357.test.ts`
...
- [ ] `routes/api/healthz-smoke-bugfix3-200192357.ts` created with specified handler
- [ ] `routes/api/healthz-smoke-bugfix3-200192357.test.ts` created with both test cases passing
...
curl http://localhost:5000/api/healthz-smoke-bugfix3-200192357
# Should return: {"ok":true,"variant":"200192357"}
```
