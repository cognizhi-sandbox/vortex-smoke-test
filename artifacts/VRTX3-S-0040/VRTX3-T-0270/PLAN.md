# PLAN — VRTX3-T-0270 · Add GET /api/healthz-smoke-503463873-c

Change: `openspec/changes/vrtx3-i-0049-smoke-178767328680848-3-independent-endpoints-50/`
Requirement: **Health probe C for variant 503463873** (`specs/health-probes/spec.md`)
Read `design.md` first.

## Objective

Serve `GET /api/healthz-smoke-503463873-c` with the literal body
...
1. Copy `routes/api/healthz-smoke-528856326-a.ts` to
   `routes/api/healthz-smoke-503463873-c.ts` and change the `variant` string to `"503463873"`.
...
2. Copy `routes/api/healthz-smoke-528856326-a.test.ts` to
   `routes/api/healthz-smoke-503463873-c.test.ts`; update the import path, the `describe` title,
...
- `routes/api/healthz-smoke-503463873-c.ts`
- `routes/api/healthz-smoke-503463873-c.test.ts`

Owned elsewhere, do not touch: `routes/api/healthz-smoke-503463873-a.*` (VRTX3-T-0268),
`routes/api/healthz-smoke-503463873-b.*` (VRTX3-T-0269). Read-only:
