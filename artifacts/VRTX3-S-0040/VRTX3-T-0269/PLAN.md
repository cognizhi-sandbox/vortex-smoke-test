# PLAN — VRTX3-T-0269 · Add GET /api/healthz-smoke-503463873-b

Change: `openspec/changes/vrtx3-i-0049-smoke-178767328680848-3-independent-endpoints-50/`
Requirement: **Health probe B for variant 503463873** (`specs/health-probes/spec.md`)
Read `design.md` first.

## Objective

Serve `GET /api/healthz-smoke-503463873-b` with the literal body
...
1. Copy `routes/api/healthz-smoke-528856326-a.ts` to
   `routes/api/healthz-smoke-503463873-b.ts` and change the `variant` string to `"503463873"`.
...
2. Copy `routes/api/healthz-smoke-528856326-a.test.ts` to
   `routes/api/healthz-smoke-503463873-b.test.ts`; update the import path, the `describe` title,
...
- `routes/api/healthz-smoke-503463873-b.ts`
- `routes/api/healthz-smoke-503463873-b.test.ts`
